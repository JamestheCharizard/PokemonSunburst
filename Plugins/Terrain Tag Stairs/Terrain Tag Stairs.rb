...
class Game_Character
  ...
  def can_move_from_coordinate?(start_x, start_y, dir, strict = false)
    ...
    if dir == 7 || dir == 1
      return true if self.map.terrain_tag(start_x, start_y).stair_type == 1 || self.map.terrain_tag(start_x, start_y).stair_type == 2
    elsif dir == 9 || dir == 3
      return true if self.map.terrain_tag(start_x, start_y).stair_type == 2 || self.map.terrain_tag(start_x, start_y).stair_type == 1
    end
