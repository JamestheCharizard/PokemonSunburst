...
module PhenomenonConfig
  Frequency = 10 # Chance for phenomenon to generate on step. Between 350-600.
  Timer = 3600 # How many frames to wait before phenomenon disappears
  Switch = 59 # Switch that when ON enables phenomena
  BattleMusic = "ARS_Battle_WildPokemon_Fate.ogg" # Custom music to play during Phenomenon
  Pokemon = {
    ...
    :hiddenAbility => 64, # Generated with hidden ability
  }
  Types = {
    # Animation ID, sound, animation height (1: above player/ 0: below)
    :PhenomenonGrass => [56, "phenomenon_grass", 1],
	:PhenomenonDarkGrass => [57, "phenomenon_grass", 1],
  ...
  # Only tiles which can be moved on but cannot be moved to need to be included
  BlockedTiles = {
 # 69 => {
  ...
  Items = {
    ...
    :commonCave => [:FIREGEM, :WATERGEM, :ICEGEM, :ELECTRICGEM, :GRASSGEM, :FIGHTINGGEM,
                    ...
                    :GHOSTGEM, :DRAGONGEM, :DARKGEM, :STEELGEM, :NORMALGEM, :FAIRYGEM, :CELESTIALGEM,
					:REDSHARD, :BLUESHARD, :YELLOWSHARD, :GREENSHARD],
    # 10% chance
...
# ASTRALNEKO NOTE: Replace this with a bird bridge whitelist much like BlockedTiles
#-------------------------------------------------------------------------------
