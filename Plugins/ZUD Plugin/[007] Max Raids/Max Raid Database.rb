    ...
    loop do
      ...
      if cmd==0
        pbFadeOutIn {
          pbSEPlay("Door enter")
          Input.update
          lvl = Settings::MAXRAID_LEVEL_RANKS[1]+rand(Settings::MAXRAID_LEVEL_GAP) if raidlvl==1
          lvl = Settings::MAXRAID_LEVEL_RANKS[2]+rand(Settings::MAXRAID_LEVEL_GAP) if raidlvl==2
          lvl = Settings::MAXRAID_LEVEL_RANKS[3]+rand(Settings::MAXRAID_LEVEL_GAP) if raidlvl==3
          lvl = Settings::MAXRAID_LEVEL_RANKS[4]+rand(Settings::MAXRAID_LEVEL_GAP) if raidlvl==4
          lvl = Settings::MAXRAID_LEVEL_RANKS[5]+rand(Settings::MAXRAID_LEVEL_GAP) if raidlvl==5
          lvl = Settings::MAXRAID_LEVEL_RANKS[6]         if raidlvl==6
