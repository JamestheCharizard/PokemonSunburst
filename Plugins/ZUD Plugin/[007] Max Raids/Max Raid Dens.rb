...
#-------------------------------------------------------------------------------
  def pbStartScene(size, rank, pkmn, loot, field, gmax, hard, storedPkmn)
    ...
    if stored!=0
      ...
      rank     = 1
      rank     = 2 if level>=Settings::MAXRAID_LEVEL_RANKS[2]
      rank     = 3 if level>=Settings::MAXRAID_LEVEL_RANKS[3]
      rank     = 4 if level>=Settings::MAXRAID_LEVEL_RANKS[4]
      rank     = 5 if level>=Settings::MAXRAID_LEVEL_RANKS[5]
      rank     = 6 if level>=Settings::MAXRAID_LEVEL_RANKS[6]
    else
      #-------------------------------------------------------------------------
      # Determines Raid Pokemon data of a newly spawned species.
      #-------------------------------------------------------------------------
      stars1 = Settings::MAXRAID_LEVEL_RANKS[1]+rand(Settings::MAXRAID_LEVEL_GAP) # 1 Star Pokemon raid levels: 15-20
      stars2 = Settings::MAXRAID_LEVEL_RANKS[2]+rand(Settings::MAXRAID_LEVEL_GAP) # 2 Star Pokemon raid levels: 30-35
      stars3 = Settings::MAXRAID_LEVEL_RANKS[3]+rand(Settings::MAXRAID_LEVEL_GAP) # 3 Star Pokemon raid levels: 40-45
      stars4 = Settings::MAXRAID_LEVEL_RANKS[4]+rand(Settings::MAXRAID_LEVEL_GAP) # 4 Star Pokemon raid levels: 50-55
      stars5 = Settings::MAXRAID_LEVEL_RANKS[5]+rand(Settings::MAXRAID_LEVEL_GAP) # 5 Star Pokemon raid levels: 60-65
      ...
      if pkmn.is_a?(Array) && !rank
        ...
        rank  = 1 if level>=Settings::MAXRAID_LEVEL_RANKS[1]
        rank  = 2 if level>=Settings::MAXRAID_LEVEL_RANKS[2]
        rank  = 3 if level>=Settings::MAXRAID_LEVEL_RANKS[3]
        rank  = 4 if level>=Settings::MAXRAID_LEVEL_RANKS[4]
        rank  = 5 if level>=Settings::MAXRAID_LEVEL_RANKS[5]
      ...
      level    = Settings::MAXRAID_LEVEL_RANKS[6] if rank>=6
