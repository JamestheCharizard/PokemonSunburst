...
module TrainerPokemonProperty
  def self.set(settingname,initsetting)
    ...
    pkmn_properties.concat([
       ...
       [_INTL("Trainer Ace"),  BooleanProperty2,                     _INTL("If set to true, the trainer will save battle gimmicks for this Pokémon.")],
	   #------------------------------------------------------------------------
       # Terastal values.
       #------------------------------------------------------------------------
	   [_INTL("Tera Type"),    TypeProperty,                         _INTL("The Tera Type of the Pokémon.")]
    ])
    ...
    ret = {
      ...
      # Terastal values.
      #-------------------------------------------------------------------------
	  :tera_type     => oldsetting[18 + Pokemon::MAX_MOVES]
    }
    moves = []
    Pokemon::MAX_MOVES.times do |i|
