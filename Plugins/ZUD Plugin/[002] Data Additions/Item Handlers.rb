...
ItemHandlers::UseOnPokemon.add(:NORMALIUMZ,proc { |item,pkmn,scene|
  crystalname = GameData::Item.get(item).portion_name
...
ItemHandlers::UseOnPokemon.copy(:NORMALIUMZ,  :FIRIUMZ,     :WATERIUMZ,   :ELECTRIUMZ, :GRASSIUMZ,
			                    ...
			                    :DARKINIUMZ,  :STEELIUMZ,   :FAIRIUMZ,    :CELESTIUMZ, :BIRDIUMZ,
								# Gen 7 type specific crystals
								:ALORAICHIUMZ,:DECIDIUMZ,   :INCINIUMZ,   :PRIMARIUMZ, :EEVIUMZ,
								:PIKANIUMZ,   :SNORLIUMZ,   :MEWNIUMZ,    :TAPUNIUMZ,  :MARSHADIUMZ,
								:PIKASHUNIUMZ,:KOMMONIUMZ,  :LYCANIUMZ,   :MIMIKIUMZ,  :LUNALIUMZ,
								:SOLGANIUMZ,  :ULTRANECROZIUMZ,
								# Gen AN-I type specific crystals
								:FELACIUMZ,   :SPIKATIUMZ,  :GLIMMORIUMZ, :TINKATIUMZ, :TOGEKIUMZ,
								:MINIORIUMZ,  :VOLCARONIUMZ)
...
ItemHandlers::UseInField.add(:MAXEGGS,proc { |item|
  ...
  pbFadeOutIn {
    ...
    screen.pbStartScene((_INTL("Consuming the {1}...",GameData::Item.get(item).portion_name)),false)
