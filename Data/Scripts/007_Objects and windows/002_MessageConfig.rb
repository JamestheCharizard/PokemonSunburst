...
module MessageConfig
  ...
  MALE_TEXT_MAIN_COLOR     = Color.new(120, 184, 232)   # Used by message tag "\b"
  MALE_TEXT_SHADOW_COLOR   = Color.new(0, 112, 248)
  FEMALE_TEXT_MAIN_COLOR   = Color.new(248, 168, 184)   # Used by message tag "\r"
  FEMALE_TEXT_SHADOW_COLOR = Color.new(232, 32, 16)
